...
| **Computer Architecture (IAC)** | K-Means Clustering Optimization | `RISC-V Assembly` | 20.00/20.00 | [Code/Repo](./first-year/IAC/) |
...
| **Arquitetura de Computadores (IAC)** | Otimização do K-Means | `RISC-V Assembly` | 20.00/20.00 | [Código/Repo](./first-year/IAC/) |
